...
export function AppSidebar() {
  ...
  return (
    <aside className="app-sidebar" aria-label="Navegação principal">
      ...
      <div className="apex-quick-stat">
        <div className="apex-quick-stat-head">
          <span>Recebido</span>
          <span className="apex-badge-up">+{pct}%</span>
        </div>
        <div className="apex-quick-stat-value">{formatarCentavos(recebido)}</div>
        <div className="apex-progress" style={{ marginTop: 10 }}>
          <div
            className="apex-progress-fill primary"
            style={{ width: `${pct}%` }}
          />
        </div>
      </div>
      <div className="apex-quick-stat">
        ...
        <div className="apex-quick-stat-value">{formatarCentavos(emAberto)}</div>
        <div className="apex-progress" style={{ marginTop: 10 }}>
          <div
            className="apex-progress-fill secondary"
            style={{
      ...
      <div className="app-sidebar-footer">
        <div className="apex-user">
          <div className="apex-avatar" aria-hidden />
          <div>
            <div className="apex-user-name">Administrador</div>
            <div className="apex-user-email">Terreno compartilhado</div>
          </div>
        </div>
