    ...
    <div className="apex-page">
      ...
      {dados && (
        <>
          ...
          {aba === "pdfs" && (
            <section className="apex-panel doc-section">
              <div className="apex-panel-head">
                <h2 className="apex-panel-title">PDFs de {dados.casa_nome}</h2>
          ...
          {aba === "fotos" && (
            <section className="apex-panel doc-section">
              <div className="apex-panel-head">
                <h2 className="apex-panel-title">Fotos de {dados.casa_nome}</h2>
                <div className="apex-panel-actions">
                  <button
                    type="button"
                    className="apex-btn-primary"
          ...
          {aba === "anotacoes" && (
            <section className="apex-panel doc-section">
              <div className="apex-panel-head">
                <h2 className="apex-panel-title">Anotações de {dados.casa_nome}</h2>
                <div className="apex-panel-actions">
                  <button
                    type="button"
                    className="apex-btn-primary"
              ...
              {dados.anotacoes.length === 0 ? (
                <div className="doc-empty">
                  ...
                  <button type="button" className="apex-btn-ghost" onClick={abrirNovaAnotacao}>
      ...
      {modalFoto && (
        <Modal title="Adicionar foto" onClose={() => !enviando && setModalFoto(false)}>
          ...
          <button
            type="button"
            className="apex-btn-primary full"
            disabled={enviando}
